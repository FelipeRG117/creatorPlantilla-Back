 ...
 *
 * Agrega productos de prueba a la base de datos para testing.
...
const productSchema = new mongoose.Schema({
  ...
  category: {
    type: String,
    enum: ['instruments', 'clothing', 'accessories', 'merch', 'music', 'other'],
    required: true
  },
  images: [{
...
const sampleProducts = [
  ...
  },
  {
    ...
    description: 'Póster artístico de edición limitada. Impresión en papel couché 300g con acabado mate. Imagen icónica de Luis Carlos Gago con su mariachi. Perfecto para enmarcar.',
    price: 280.00,
    category: 'merch',
    images: [
      {
  ...
  },
  {
    ...
    description: 'Guitarrón profesional de concierto, creado por luthiers mexicanos. Madera de cedro rojo seleccionada, acabado brillante. Incluye funda acolchada y certificado de autenticidad firmado por Luis Carlos Gago.',
    price: 15999.00,
  ...
  },
  {
    ...
    description: 'Sudadera premium con capucha y bolsillo canguro. Mezcla de algodón y poliéster para máxima comodidad. Diseño exclusivo "Mariachi Soul" estampado en pecho y espalda. Interior afelpado.',
    price: 750.00,
    category: 'clothing',
    images: [
      {
  ...
  },
  {
    ...
    description: 'Taza de cerámica premium de 350ml. Diseño artístico con frase inspiradora de Luis Carlos Gago. Apta para microondas y lavavajillas. Viene en caja de regalo elegante.',
    price: 220.00,
    category: 'merch',
    images: [
      {
  ...
  },
  {
    ...
    description: 'Llavero de metal premium con baño de oro. Logo de Luis Carlos Gago grabado con láser. Incluye argolla giratoria de alta resistencia. Presentado en bolsa de terciopelo.',
    price: 150.00,
    category: 'accessories',
    images: [
      {
...
async function seedProducts() {
  try {
    ...
    // Connect to MongoDB
    const mongoUri = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/mariachi-web';
    ...
    inserted.forEach((product, index) => {
      ...
      console.log(`   - Stock: ${product.variants.reduce((sum, v) => sum + v.stock, 0)} unidades`);
    ...
    console.log(`💰 Valor total inventario: $${inserted.reduce((sum, p) => sum + (p.price * p.variants.reduce((s, v) => s + v.stock, 0)), 0).toFixed(2)} MXN`);
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
